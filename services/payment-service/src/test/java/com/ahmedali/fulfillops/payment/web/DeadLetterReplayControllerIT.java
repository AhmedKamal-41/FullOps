...
import com.ahmedali.fulfillops.payment.messaging.DeadLetterEvent;
import com.ahmedali.fulfillops.payment.messaging.DeadLetterEventRepository;
import com.ahmedali.fulfillops.payment.messaging.DeadLetterEventStatus;
 ...
 * original bytes and lets it reprocess — while a non-ADMIN is forbidden, an unknown event id 404s,
 * and replaying the same event twice is rejected as a conflict.
 */
