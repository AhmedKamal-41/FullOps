 ...
 * cancellation is never automatic. reasonCode is machine-readable on purpose: a later phase's
 * REQUIRES_REVIEW routing (see docs/DOMAIN_MODEL.md's compensation rules) can key off it instead of
 * parsing free text.
 */
