...
COMMENT ON DATABASE fulfillment_db IS
    'Owned exclusively by fulfillment-service. No other service may connect to this database. See docs/adr/0001-service-boundaries.md.';
