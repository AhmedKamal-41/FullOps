...
/**
 * Orchestrates release attempts with the same bounded-retry shape as ReservationService. Kafka
 * compensation listeners call this capability when a reservation must be released.
 */
@Service
