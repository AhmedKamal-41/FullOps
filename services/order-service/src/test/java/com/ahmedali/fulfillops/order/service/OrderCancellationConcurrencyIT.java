 ...
 * error logged, which is exactly what a live smoke run of the cancellation saga caught (see
 * PHASE_STATUS.md). Calling OrderCancellationTransaction directly (not through Kafka) means this
