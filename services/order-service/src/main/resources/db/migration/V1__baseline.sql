...
COMMENT ON DATABASE order_db IS
    'Owned exclusively by order-service. No other service may connect to this database. See docs/adr/0001-service-boundaries.md.';
