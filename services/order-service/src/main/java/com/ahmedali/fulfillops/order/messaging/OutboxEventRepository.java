...
public interface OutboxEventRepository extends JpaRepository<OutboxEvent, UUID> {
  ...
  // OutboxRelay's own retry budget) — see OperationsKpiController's "DLT/outbox backlog" KPI.
  // state is plain String on OutboxEvent (not @Enumerated), so these bind a String, not
  // OutboxState directly — OutboxState.PUBLISHED.name() at the call site.
